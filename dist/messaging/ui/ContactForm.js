...
var ContactForm = function ContactForm(props) {
  ...
  var formValidator = (0, _react.useState)(new _FormValidator.default())[0];
  ...
  var handleError = function handleError(ex) {
    ...
    setErrors({
      general: ex.message || ex.toString()
    });
    return new Error(ex.general);
  };
  var viewError = function viewError(errorFieldKey) {
    if (!errors || typeof errors[errorFieldKey] !== "string") return null;
    return /*#__PURE__*/_react.default.createElement("aside", {
      className: "error"
    }, errors[errorFieldKey]);
  };
  var createJson = function createJson() {
    var _nameRef$current, _emailRef$current, _phoneRef$current, _subjectRef$current, _messageRef$current;
    return {
  ...
  var sendMessageAsync = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var isValid, data, rsp, isAsync, result;
    ...
    return function sendMessageAsync(_x2) {
      return _ref.apply(this, arguments);
    };
  }();
  var subjectOptionList = Array.isArray(subjectOptions) ? subjectOptions.map(function (option) {
    var text = (option === null || option === void 0 ? void 0 : option.toString()) || "";
    var value = null;
    if (_typeof(option) === "object") {
      text = (option === null || option === void 0 ? void 0 : option.text) || (option === null || option === void 0 ? void 0 : option.label) || (option === null || option === void 0 ? void 0 : option.caption) || (option === null || option === void 0 ? void 0 : option.desc) || (option === null || option === void 0 ? void 0 : option.description);
      value = (option === null || option === void 0 ? void 0 : option.value) || (option === null || option === void 0 ? void 0 : option.val) || (option === null || option === void 0 ? void 0 : option.payload) || text;
    }
    return {
      text: text,
      value: value
  ...
  var subjectElement = subjectOptionList.length > 0 ? /*#__PURE__*/_react.default.createElement("fieldset", null, /*#__PURE__*/_react.default.createElement("label", {
    htmlFor: "subject"
  }, "Subject"), /*#__PURE__*/_react.default.createElement("select", {
    id: "subject",
    name: "subject",
    ref: subjectRef
  }, subjectOptionList.map(function (option) {
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    htmlFor: "name"
  }, "Name ", viewError("name")), /*#__PURE__*/_react.default.createElement("input", {
    type: "text",
    id: "name",
    name: "name",
    ref: nameRef
  }), viewError("name")), /*#__PURE__*/_react.default.createElement("fieldset", null, /*#__PURE__*/_react.default.createElement("label", {
    htmlFor: "email"
  }, "Email ", viewError("email")), /*#__PURE__*/_react.default.createElement("input", {
    type: "email",
    id: "email",
    name: "email",
    ref: emailRef
    ...
    name: "phone",
    ref: phoneRef
  }), viewError("phone")), subjectElement, /*#__PURE__*/_react.default.createElement("fieldset", null, /*#__PURE__*/_react.default.createElement("label", {
    htmlFor: "message"
  }, "Message ", viewError("message")), /*#__PURE__*/_react.default.createElement("textarea", {
    id: "message",
    name: "message",
    ref: messageRef
