...
var PersonForm = function PersonForm(props) {
  ...
  var lastNameRef = (0, _react.useRef)();
  ...
  var createJson = function createJson() {
    var _firstNameRef$current, _lastNameRef$current, _emailRef$current, _phoneRef$current;
    return {
      first_name: ((_firstNameRef$current = firstNameRef.current) === null || _firstNameRef$current === void 0 ? void 0 : _firstNameRef$current.value) || null,
      last_name: ((_lastNameRef$current = lastNameRef.current) === null || _lastNameRef$current === void 0 ? void 0 : _lastNameRef$current.value) || null,
  ...
  var getControllerKey = function getControllerKey() {
    return typeof controllerKey === "string" && controllerKey.length > 0 ? controllerKey : "person-form";
  };
  ...
  var createValidator = function createValidator() {
    ...
    var firstNameMessage = "First name is reqiured";
    var lastNameMessage = "Last name is required";
    var emailMessage = "Valid email is required";
  ...
  var validateForm = function validateForm(json) {
    ...
    setErrors(ex);
    var hasErrors = Object.keys(ex).length === 0;
    controller === null || controller === void 0 ? void 0 : controller.setErrors(ex);
    if (hasErrors && typeof onError === 'function') onError(hasErrors);
    return hasErrors;
  };
  ...
  var phoneElement = (requiredFields === null || requiredFields === void 0 ? void 0 : requiredFields.phone) !== false ? /*#__PURE__*/_react.default.createElement("div", {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "form-group double spaced"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "half"
  }, /*#__PURE__*/_react.default.createElement("label", {
    ...
    ref: firstNameRef,
    onBlur: function onBlur(e) {
      return clearErrors("first_name");
    }
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "form-error"
  }, viewError("first_name"))), /*#__PURE__*/_react.default.createElement("div", {
    className: "half"
  }, /*#__PURE__*/_react.default.createElement("label", {
    ...
    className: "form-error"
  }, viewError("last_name")))), /*#__PURE__*/_react.default.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/_react.default.createElement("label", {
    ...
    className: "form-error"
  }, viewError("email"))), phoneElement, buttonElement);
};
