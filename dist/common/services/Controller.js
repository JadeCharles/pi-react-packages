...
var Controller = /*#__PURE__*/function () {
  function Controller(props) {
    ...
    this.formGetters = _typeof(props.formGetters) === "object" ? props.formGetters : {};
  ...
  _createClass(Controller, [{
    ...
    value: function getFormData() {
      var formKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var fallbackToDefault = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      if (!formKey || typeof formKey !== "string") return this.getData(options);
