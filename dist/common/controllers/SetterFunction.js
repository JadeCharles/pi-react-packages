...
var SetterFunction = /*#__PURE__*/function () {
  /**
  ...
  function SetterFunction() {
    var onSet = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, SetterFunction);
    this.onSet = null;
    this.setFunction(onSet);
  }
  _createClass(SetterFunction, [{
    key: "set",
    value: function set(value) {
      if (typeof this.onSet === "function") {
        var result = this.onSet(value);
