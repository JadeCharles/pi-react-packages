...
var DeleteButton = function DeleteButton(props) {
  ...
  var onDeleteAsync = /*#__PURE__*/function () {
    ...
    return function onDeleteAsync(_x2) {
  ...
  var onClickAsync = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", onDeleteAsync(e));
          case 4:
            if (deleteState === 1) setDeleteState(2);else if (deleteState === 0) setDeleteState(1);
          case 5:
          case "end":
    ...
    return function onClickAsync(_x3) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (deleteState === 3) {
      setTimeout(function () {
        return setDeleteState(0);
      }, 3000);
    }
  }, [deleteState]);
  var cn = typeof className === 'string' ? className : "";
  var body = typeof deleteState === "string" ? deleteState : children;
  switch (deleteState) {
    case 1:
  ...
  var c = deleteState === 2 ? 0 : typeof countDown === "number" && countDown > 0 ? countDown : 8;
  var confirmClass = deleteState === 1 ? "countdown" : deleteState === 2 ? "deleting" : "";
  var st = {
    animationDuration: (c + 0.2).toFixed(1) + "s"
  };
  return /*#__PURE__*/_react.default.createElement("a", {
    ref: deleteRef,
    onBlur: onBlur,
    className: ("delete-button " + cn + " " + getDeleteClassName()).trim(),
    onClick: onClickAsync
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "delete-button-content"
