...
var FormButton = function FormButton(props) {
  ...
  var buttonId = id || 'dark-button-' + Math.floor(Math.random() * 1000000).toString();
  ...
  var _useState3 = (0, _react.useState)(0),
    ...
    confirmState = _useState4[0],
    setConfirmState = _useState4[1];
  var _useState5 = (0, _react.useState)(""),
    _useState6 = _slicedToArray(_useState5, 2),
    tempButtonCaption = _useState6[0],
    setTempButtonCaption = _useState6[1];
  var buttonRef = (0, _react.useRef)(null);
  var hasConfirmPrompt = !!confirmPrompt;
  var confirmClasses = {
  ...
  var onButtonClick = /*#__PURE__*/function () {
    ...
    return function onButtonClick(_x2) {
      return _ref.apply(this, arguments);
    };
  }();
  var confirmClick = /*#__PURE__*/function () {
    ...
    return function confirmClick(_x3) {
  ...
  var body = confirmState === 1 ? cancel || "Cancel" : tempButtonCaption || label || children || 'Okay';
  var cn = typeof className === 'string' ? " " + className : "";
  var button = /*#__PURE__*/_react.default.createElement("button", {
    id: buttonId,
    className: ("dark-button" + cn + buttonClassName).trim(),
    ref: buttonRef,
  ...
  if (hasConfirmPrompt) {
    var confirmElement = /*#__PURE__*/_react.default.createElement("a", {
      onClick: confirmClick
    }, confirmPrompt);
    return /*#__PURE__*/_react.default.createElement(_material.ClickAwayListener, {
      onClickAway: function onClickAway() {
        return setConfirmState(0);
      }
