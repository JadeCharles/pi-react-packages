...
var CopyText = function CopyText(props) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(textToCopy) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _ = CopyText.copy(textToCopy).then(function () {
  ...
  (0, _react.useEffect)(function () {
    if (copyState === 1) {
      setTimeout(function () {
        return setCopyState(0);
      }, 3000);
    }
  }, [copyState]);
  var contentToCopy = typeof text === 'string' ? text : typeof children === 'string' ? children : _server.default.renderToString(children);
  var actionLabel = copyState === 1 ? copiedLabel || "Copied!" : label || "Copy";
