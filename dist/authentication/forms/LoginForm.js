...
var LoginForm = function LoginForm(props) {
  ...
  var onKeyUpAsync = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("Enter!");
            rsp = buttonController.onClick(e);
            if (!(typeof rsp.then === 'function')) {
              _context.next = 7;
              break;
            }
            _context.next = 7;
            return rsp.then(function (result) {
    ...
    return function onKeyUpAsync(_x2) {
  ...
  var handleError = function handleError(ex) {
    ...
    var msg = (ex === null || ex === void 0 ? void 0 : (_ex$response = ex.response) === null || _ex$response === void 0 ? void 0 : (_ex$response$data = _ex$response.data) === null || _ex$response$data === void 0 ? void 0 : _ex$response$data.message) || defaultErrorMessage;
    setError(msg);
    return msg;
  };
  ...
  var authenticateAsync = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var _usernameRef$current, _passwordRef$current;
      var username, password, element, rsp, session, completeRsp, red;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            throw new Error("LoginForm: onClick function was not set");
          case 2:
          ...
          case 19:
            ...
            return _context2.abrupt("return", false);
          case 22:
            completeRsp = typeof onComplete === 'function' ? onComplete(session) : null;
            if (!(completeRsp === false)) {
              _context2.next = 25;
              break;
            }
    ...
    return function authenticateAsync(_x3) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    htmlFor: "username"
  }, (labels === null || labels === void 0 ? void 0 : labels.login) || (labels === null || labels === void 0 ? void 0 : labels.username) || (isEmail === true ? "Email Address" : "Username")), /*#__PURE__*/_react.default.createElement("input", {
    type: isEmail === true ? "email" : "text",
    id: "username",
    name: "username",
    ref: usernameRef
  })), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, error), /*#__PURE__*/_react.default.createElement(_FormButton.default, {
    continueActivity: true,
    controller: buttonController,
    onClick: authenticateAsync
  }, (labels === null || labels === void 0 ? void 0 : labels.button) || "Sign in")));
};
